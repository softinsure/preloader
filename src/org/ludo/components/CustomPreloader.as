package org.ludo.components
{
    ...
    public class CustomPreloader extends Sprite implements IPreloaderDisplay
    {
    	...
    	[Embed("assets/logo/logomain.png") ]
        [Bindable] 
		...
		private var barColors:Array = [ 0x6B9046, 0x6B9046, 0x6B9046, 0x6B9046 ];  //0x0687d7;
        // the progress bar border color
		//private var barBorderColor:uint = 0xdddddd;
		private var barBorderColor:uint = 0x8EC675;
